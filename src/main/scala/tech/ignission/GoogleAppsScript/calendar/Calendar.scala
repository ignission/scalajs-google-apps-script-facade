...
import tech.ignission.GoogleAppsScript.base.{Date, Month, Weekday}
...
trait Calendar extends js.Object {
  ...
  def createAllDayEvent(title: String, date: Date, options: js.Dictionary[js.Any]): CalendarEvent = js.native
  def createAllDayEventSeries(title: String, startDate: Date, recurrence: EventRecurrence): CalendarEventSeries = js.native
  def createAllDayEventSeries(title: String, startDate: Date, recurrence: EventRecurrence, options: js.Dictionary[js.Any]): CalendarEventSeries = js.native
  def createEvent(title: String, startTime: Date, endTime: Date): CalendarEvent = js.native
  def createEvent(title: String, startTime: Date, endTime: Date, options: js.Dictionary[js.Any]): CalendarEvent = js.native
  ...
  def createEventSeries(title: String, startTime: Date, endTime: Date, recurrence: EventRecurrence, options: js.Dictionary[js.Any]): CalendarEventSeries = js.native
  ...
  def getEvents(startTime: Date, endTime: Date, options: js.Dictionary[js.Any]): js.Array[CalendarEvent] = js.native
  def getEventsForDay(date: Date): js.Array[CalendarEvent] = js.native
  def getEventsForDay(date: Date, options: js.Dictionary[js.Any]): js.Array[CalendarEvent] = js.native
