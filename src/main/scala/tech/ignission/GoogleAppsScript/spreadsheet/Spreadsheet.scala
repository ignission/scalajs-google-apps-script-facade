...
import tech.ignission.GoogleAppsScript._
import tech.ignission.GoogleAppsScript.base.{Blob, BlobSource, ColorType, Date, RgbColor, Ui, User}
import tech.ignission.GoogleAppsScript.charts._
import tech.ignission.GoogleAppsScript.drive.File
import tech.ignission.GoogleAppsScript.html.HtmlOutput
...
trait Banding extends js.Object {
  def copyTo(range: document.Range): Banding = js.native
  ...
  def getRange(): document.Range = js.native
  ...
  def setRange(range: document.Range): Banding = js.native
...
trait ConditionalFormatRule extends js.Object {
  ...
  def getRanges(): js.Array[document.Range] = js.native
}
...
trait ConditionalFormatRuleBuilder extends js.Object {
  ...
  def setRanges(ranges: js.Array[document.Range]): ConditionalFormatRuleBuilder = js.native
...
trait DataValidationBuilder extends js.Object {
  ...
  def requireValueInRange(range: document.Range): DataValidationBuilder = js.native
  def requireValueInRange(range: document.Range, showDropdown: Boolean): DataValidationBuilder = js.native
...
trait DeveloperMetadata extends js.Object {
  ...
  def moveToColumn(column: document.Range): DeveloperMetadata = js.native
  def moveToRow(row: document.Range): DeveloperMetadata = js.native
...
trait DeveloperMetadataLocation extends js.Object {
  def getColumn(): document.Range | Null = js.native
  def getLocationType(): DeveloperMetadataLocationType = js.native
  def getRow(): document.Range | Null = js.native
...
trait EmbeddedAreaChartBuilder extends js.Object {
  def addRange(range: document.Range): EmbeddedChartBuilder = js.native
  ...
  def getRanges(): js.Array[document.Range] = js.native
  def removeRange(range: document.Range): EmbeddedChartBuilder = js.native
...
trait NamedRange extends js.Object {
  ...
  def getRange(): document.Range = js.native
  def remove(): Unit = js.native
  def setName(name: String): document.NamedRange = js.native
  def setRange(range: document.Range): document.NamedRange = js.native
}
...
trait OverGridImage extends js.Object {
  ...
  def getAnchorCell(): document.Range = js.native
  ...
  def setAnchorCell(cell: document.Range): OverGridImage = js.native
...
trait Protection extends js.Object {
  ...
  def getUnprotectedRanges(): js.Array[document.Range] = js.native
  ...
  def setRange(range: document.Range): Protection = js.native
  def setRangeName(rangeName: String): Protection = js.native
  def setUnprotectedRanges(ranges: js.Array[document.Range]): Protection = js.native
...
trait Range extends js.Object {
  def activate(): document.Range = js.native
  def activateAsCurrentCell(): document.Range = js.native
  def addDeveloperMetadata(key: String): document.Range = js.native
  def addDeveloperMetadata(key: String, visibility: DeveloperMetadataVisibility): document.Range = js.native
  def addDeveloperMetadata(key: String, value: String): document.Range = js.native
  def addDeveloperMetadata(key: String, value: String, visibility: DeveloperMetadataVisibility): document.Range = js.native
  ...
  def autoFill(destination: document.Range, series: AutoFillSeries): Unit = js.native
  def autoFillToNeighbor(series: AutoFillSeries): Unit = js.native
  def breakApart(): document.Range = js.native
  def canEdit(): Boolean = js.native
  def check(): document.Range = js.native
  def clear(): document.Range = js.native
  def clear(options: js.Any): document.Range = js.native
  def clearContent(): document.Range = js.native
  def clearDataValidations(): document.Range = js.native
  def clearFormat(): document.Range = js.native
  def clearNote(): document.Range = js.native
  def collapseGroups(): document.Range = js.native
  ...
  def copyTo(destination: document.Range): Unit = js.native
  def copyTo(destination: document.Range, copyPasteType: CopyPasteType, transposed: Boolean): Unit = js.native
  def copyTo(destination: document.Range, options: js.Any): Unit = js.native
  ...
  def getCell(row: Integer, column: Integer): document.Range = js.native
  def getColumn(): Integer = js.native
  def getDataRegion(): document.Range = js.native
  def getDataRegion(dimension: Dimension): document.Range = js.native
  ...
  def getMergedRanges(): js.Array[document.Range] = js.native
  def getNextDataCell(direction: Direction): document.Range = js.native
  ...
  def getTextStyle(): charts.TextStyle = js.native
  def getTextStyles(): js.Array[js.Array[charts.TextStyle]] = js.native
  ...
  def insertCells(shiftDimension: Dimension): document.Range = js.native
  def insertCheckboxes(): document.Range = js.native
  def insertCheckboxes(checkedValue: js.Any): document.Range = js.native
  def insertCheckboxes(checkedValue: js.Any, uncheckedValue: js.Any): document.Range = js.native
  ...
  def merge(): document.Range = js.native
  def mergeAcross(): document.Range = js.native
  def mergeVertically(): document.Range = js.native
  def moveTo(target: document.Range): Unit = js.native
  def offset(rowOffset: Integer, columnOffset: Integer): document.Range = js.native
  def offset(rowOffset: Integer, columnOffset: Integer, numRows: Integer): document.Range = js.native
  def offset(rowOffset: Integer, columnOffset: Integer, numRows: Integer, numColumns: Integer): document.Range = js.native
  def protect(): Protection = js.native
  def randomize(): document.Range = js.native
  def removeCheckboxes(): document.Range = js.native
  def removeDuplicates(): document.Range = js.native
  def removeDuplicates(columnsToCompare: js.Array[Integer]): document.Range = js.native
  def setBackground(color: String | Null): document.Range = js.native
  def setBackgroundRGB(red: Integer, green: Integer, blue: Integer): document.Range = js.native
  def setBackgrounds(color: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setBorder(top: Boolean | Null, left: Boolean | Null, bottom: Boolean | Null, right: Boolean | Null, vertical: Boolean | Null, horizontal: Boolean | Null): document.Range = js.native
  def setBorder(top: Boolean | Null, left: Boolean | Null, bottom: Boolean | Null, right: Boolean | Null, vertical: Boolean | Null, horizontal: Boolean | Null, color: String | Null, style: BorderStyle | Null): document.Range = js.native
  def setDataValidation(rule: DataValidation | Null): document.Range = js.native
  def setDataValidations(rules: js.Array[js.Array[DataValidation | Null]]): document.Range = js.native
  def setFontColor(color: String | Null): document.Range = js.native
  def setFontColors(colors: js.Array[js.Array[js.Any]]): document.Range = js.native
  def setFontFamilies(fontFamilies: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setFontFamily(fontFamily: String | Null): document.Range = js.native
  def setFontLine(fontLine: String | Null): document.Range = js.native
  def setFontLines(fontLines: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setFontSize(size: Integer): document.Range = js.native
  def setFontSizes(sizes: js.Array[js.Array[Integer]]): document.Range = js.native
  def setFontStyle(fontStyle: String | Null): document.Range = js.native
  def setFontStyles(fontStyles: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setFontWeight(fontWeight: String | Null): document.Range = js.native
  def setFontWeights(fontWeights: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setFormula(formula: String): document.Range = js.native
  def setFormulaR1C1(formula: String): document.Range = js.native
  def setFormulas(formulas: js.Array[js.Array[String]]): document.Range = js.native
  def setFormulasR1C1(formulas: js.Array[js.Array[String]]): document.Range = js.native
  def setHorizontalAlignment(alignment: String | Null): document.Range = js.native
  def setHorizontalAlignments(alignments: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setNote(note: String | Null): document.Range = js.native
  def setNotes(notes: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setNumberFormat(numberFormat: String): document.Range = js.native
  def setNumberFormats(numberFormats: js.Array[js.Array[String]]): document.Range = js.native
  def setRichTextValue(value: RichTextValue): document.Range = js.native
  def setRichTextValues(values: js.Array[js.Array[RichTextValue]]): document.Range = js.native
  def setShowHyperlink(showHyperlink: Boolean): document.Range = js.native
  def setTextDirection(direction: TextDirection | Null): document.Range = js.native
  def setTextDirections(directions: js.Array[js.Array[TextDirection | Null]]): document.Range = js.native
  def setTextRotation(degrees: Integer): document.Range = js.native
  def setTextRotation(rotation: TextRotation): document.Range = js.native
  def setTextRotations(rotations: js.Array[js.Array[TextRotation]]): document.Range = js.native
  def setTextStyle(style: charts.TextStyle): document.Range = js.native
  def setTextStyles(styles: js.Array[js.Array[charts.TextStyle]]): document.Range = js.native
  def setValue(value: js.Any): document.Range = js.native
  def setValues(values: js.Array[js.Array[js.Any]]): document.Range = js.native
  def setVerticalAlignment(alignment: String | Null): document.Range = js.native
  def setVerticalAlignments(alignments: js.Array[js.Array[String | Null]]): document.Range = js.native
  def setVerticalText(isVertical: Boolean): document.Range = js.native
  def setWrap(isWrapEnabled: Boolean): document.Range = js.native
  def setWrapStrategies(strategies: js.Array[js.Array[WrapStrategy]]): document.Range = js.native
  def setWrapStrategy(strategy: WrapStrategy): document.Range = js.native
  def setWraps(isWrapEnabled: js.Array[js.Array[Boolean]]): document.Range = js.native
  def shiftColumnGroupDepth(delta: Integer): document.Range = js.native
  def shiftRowGroupDepth(delta: Integer): document.Range = js.native
  def sort(sortSpecObj: js.Any): document.Range = js.native
  ...
  def trimWhitespace(): document.Range = js.native
  def uncheck(): document.Range = js.native
}
...
trait RangeList extends js.Object {
  ...
  def setFontLine(fontLine: String | Null): RangeList = js.native
  def setFontSize(size: Integer): RangeList = js.native
  def setFontStyle(fontStyle: String | Null): RangeList = js.native
  def setFontWeight(fontWeight: String | Null): RangeList = js.native
...
trait RichTextValue extends js.Object {
  ...
  def getTextStyle(): charts.TextStyle = js.native
  def getTextStyle(startOffset: Integer, endOffset: Integer): charts.TextStyle = js.native
}
...
trait RichTextValueBuilder extends js.Object {
  ...
  def setTextStyle(startOffset: Integer, endOffset: Integer, textStyle: charts.TextStyle | Null): RichTextValueBuilder = js.native
  def setTextStyle(textStyle: charts.TextStyle | Null): RichTextValueBuilder = js.native
}

@js.native
trait Selection extends js.Object {
  def getActiveRange(): document.Range | Null = js.native
  def getActiveRangeList(): RangeList | Null = js.native
  def getActiveSheet(): Sheet = js.native
  def getCurrentCell(): document.Range | Null = js.native
  def getNextDataRange(direction: Direction): document.Range | Null = js.native
}
...
trait Sheet extends js.Object {
  ...
  def getActiveCell(): document.Range = js.native
  def getActiveRange(): document.Range | Null = js.native
  def getActiveRangeList(): RangeList | Null = js.native
  def getBandings(): js.Array[Banding] = js.native
  ...
  def getCurrentCell(): document.Range | Null = js.native
  def getDataRange(): document.Range = js.native
  def getDataSourceTables(): js.Array[DataSourceTable] = js.native
  def getDeveloperMetadata(): js.Array[DeveloperMetadata] = js.native
  def getFilter(): Filter | Null = js.native
  ...
  def getName(): String = js.native
  def getNamedRanges(): js.Array[document.NamedRange] = js.native
  ...
  def getRange(row: Integer, column: Integer): document.Range = js.native
  def getRange(row: Integer, column: Integer, numRows: Integer): document.Range = js.native
  def getRange(row: Integer, column: Integer, numRows: Integer, numColumns: Integer): document.Range = js.native
  def getRange(a1Notation: String): document.Range = js.native
  ...
  def insertSlicer(range: document.Range, anchorRowPos: Integer, anchorColPos: Integer): Slicer = js.native
  def insertSlicer(range: document.Range, anchorRowPos: Integer, anchorColPos: Integer, offsetX: Integer, offsetY: Integer): Slicer = js.native
  ...
  def moveColumns(columnSpec: document.Range, destinationIndex: Integer): Unit = js.native
  def moveRows(rowSpec: document.Range, destinationIndex: Integer): Unit = js.native
  def newChart(): EmbeddedChartBuilder = js.native
  def protect(): Protection = js.native
  def removeChart(chart: EmbeddedChart): Unit = js.native
  def setActiveRange(range: document.Range): document.Range = js.native
  def setActiveRangeList(rangeList: RangeList): RangeList = js.native
  def setActiveSelection(range: document.Range): document.Range = js.native
  def setActiveSelection(a1Notation: String): document.Range = js.native
  ...
  def setCurrentCell(cell: document.Range): document.Range = js.native
  ...
  def unhideColumn(column: document.Range): Unit = js.native
  def unhideRow(row: document.Range): Unit = js.native
...
trait Slicer extends js.Object {
  ...
  def getTitleTextStyle(): charts.TextStyle = js.native
  ...
  def setRange(rangeApi: document.Range): Slicer = js.native
  ...
  def setTitleTextStyle(textStyle: charts.TextStyle): Slicer = js.native
}
...
trait Spreadsheet extends js.Object {
  ...
  def getProtections(`type`: ProtectionType): js.Array[Protection] = js.native
  def getRange(a1Notation: String): document.Range = js.native
  def getRangeByName(name: String): document.Range | Null = js.native
  def getRangeList(a1Notations: js.Array[String]): RangeList = js.native
  ...
  def setNamedRange(name: String, range: document.Range): Unit = js.native
...
trait SpreadsheetApp extends js.Object {
  ...
  def newTextStyle(): charts.TextStyleBuilder = js.native
...
trait TextFinder extends js.Object {
  def findAll(): js.Array[document.Range] = js.native
  def findNext(): document.Range | Null = js.native
  def findPrevious(): document.Range | Null = js.native
  def getCurrentMatch(): document.Range | Null = js.native
  ...
  def startFrom(startRange: document.Range): TextFinder = js.native
...
trait TextStyle extends js.Object {
  def copy(): charts.TextStyleBuilder = js.native
  def getFontFamily(): String | Null = js.native
...
trait TextStyleBuilder extends js.Object {
  def build(): charts.TextStyle = js.native
  def setBold(bold: Boolean): charts.TextStyleBuilder = js.native
  def setFontFamily(fontFamily: String): charts.TextStyleBuilder = js.native
  def setFontSize(fontSize: Integer): charts.TextStyleBuilder = js.native
  def setForegroundColor(cssString: String): charts.TextStyleBuilder = js.native
  def setItalic(italic: Boolean): charts.TextStyleBuilder = js.native
  def setStrikethrough(strikethrough: Boolean): charts.TextStyleBuilder = js.native
  def setUnderline(underline: Boolean): charts.TextStyleBuilder = js.native
}
