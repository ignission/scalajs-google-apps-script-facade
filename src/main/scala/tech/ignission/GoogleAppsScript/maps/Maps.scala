...
import tech.ignission.GoogleAppsScript.base.{Blob, Date}
...
trait Geocoder extends js.Object {
  ...
  def reverseGeocode(swLatitude: Double, swLongitude: Double, neLatitude: Double, neLongitude: Double): js.Dynamic = js.native
