...
import tech.ignission.GoogleAppsScript.base.{Date, Month}
...
trait Contact extends js.Object {
  def addAddress(label: Field | String, address: String): AddressField = js.native
  def addCompany(company: String, title: String): CompanyField = js.native
  def addCustomField(label: ExtendedField | String, content: js.Any): CustomField = js.native
  def addDate(label: Field | String, month: Month, day: Integer, year: Integer): DateField = js.native
  def addEmail(label: Field | String, address: String): EmailField = js.native
  def addIM(label: Field | String, address: String): IMField = js.native
  def addPhone(label: Field | String, number: String): PhoneField = js.native
  def addToGroup(group: ContactGroup): Contact = js.native
  def addUrl(label: Field | String, url: String): UrlField = js.native
  def deleteContact(): Unit = js.native
  def getAddresses(): js.Array[AddressField] = js.native
  def getAddresses(label: Field | String): js.Array[AddressField] = js.native
  ...
  def getCustomFields(label: ExtendedField | String): js.Array[CustomField] = js.native
  def getDates(): js.Array[DateField] = js.native
  def getDates(label: Field | String): js.Array[DateField] = js.native
  def getEmails(): js.Array[EmailField] = js.native
  def getEmails(label: Field | String): js.Array[EmailField] = js.native
  ...
  def getIMs(label: Field | String): js.Array[IMField] = js.native
  ...
  def getPhones(label: Field | String): js.Array[PhoneField] = js.native
  ...
  def getUrls(label: Field | String): js.Array[UrlField] = js.native
