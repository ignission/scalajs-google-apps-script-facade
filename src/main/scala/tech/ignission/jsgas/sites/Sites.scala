package tech.ignission.jsgas.sites

import tech.ignission.jsgas.base.{Blob, BlobSource, Date, User}
...
trait SitesApp extends js.Object {
  ...
  def copySite(domain: String, name: String, title: String, summary: String, site: Site): Site =
    js.native
