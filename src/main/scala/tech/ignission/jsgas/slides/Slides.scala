...
import tech.ignission.jsgas.base.{Blob, BlobSource, ColorType, RgbColor, Ui, User}
import tech.ignission.jsgas.spreadsheet.EmbeddedChart
...
trait Layout extends js.Object {
  ...
  def getPlaceholder(placeholderType: PlaceholderType, placeholderIndex: Integer): PageElement =
    js.native
  ...
  def replaceAllText(findText: String, replaceText: String, matchCase: Boolean): Integer =
    js.native
...
trait Presentation extends js.Object {
  ...
  def insertSlide(insertionIndex: Integer, slide: Slide, linkingMode: SlideLinkingMode): Slide =
    js.native
