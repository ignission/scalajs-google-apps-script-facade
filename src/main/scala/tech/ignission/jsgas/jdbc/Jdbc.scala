...
import tech.ignission.jsgas.GoogleAppsScript.BigNumber
...
trait JdbcDatabaseMetaData extends js.Object {
  ...
  def getConnection(): JdbcConnection = js.native
  def getCrossReference(parentCatalog: String, parentSchema: String, parentTable: String, foreignCatalog: String, foreignSchema: String, foreignTable: String): JdbcResultSet = js.native
