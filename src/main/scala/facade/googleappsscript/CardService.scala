...
@js.native
sealed trait DisplayStyle extends js.Object {
}

@js.native
@JSGlobal("GoogleAppsScript.Card_Service.DisplayStyle")
object DisplayStyle extends js.Object {
  var PEEK: DisplayStyle = js.native
  var REPLACE: DisplayStyle = js.native
  @JSBracketAccess
  def apply(value: DisplayStyle): String = js.native
}
...
trait CardBuilder extends js.Object {
  ...
  def setFixedFooter(fixedFooter: FixedFooter): CardBuilder = js.native
  def setDisplayStyle(displayStyle: DisplayStyle): CardBuilder = js.native
  def setPeekCardHeader(peekCardHeader: CardHeader): CardBuilder = js.native
}
...
trait CardService extends js.Object {
  ...
  def newDecoratedText(): DecoratedText = js.native
  ...
  def newUpdateDraftBccRecipientsAction(): UpdateDraftBccRecipientsAction = js.native
  def newUpdateDraftBodyAction(): UpdateDraftBodyAction = js.native
  def newUpdateDraftCcRecipientsAction(): UpdateDraftCcRecipientsAction = js.native
  def newUpdateDraftSubjectAction(): UpdateDraftSubjectAction = js.native
  def newUpdateDraftToRecipientsAction(): UpdateDraftToRecipientsAction = js.native
}
...
@js.native
sealed trait SwitchControlType extends js.Object {
}

@js.native
@JSGlobal("GoogleAppsScript.Card_Service.SwitchControlType")
object SwitchControlType extends js.Object {
  var SWITCH: SwitchControlType = js.native
  var CHECK_BOX: SwitchControlType = js.native
  @JSBracketAccess
  def apply(value: SwitchControlType): String = js.native
}
...
trait UpdateDraftActionResponseBuilder extends js.Object {
  ...
  def setUpdateDraftBccRecipientsAction(updateDraftBccRecipientsAction: UpdateDraftBccRecipientsAction): UpdateDraftActionResponseBuilder = js.native
  def setUpdateDraftBodyAction(updateDraftBodyAction: UpdateDraftBodyAction): UpdateDraftActionResponseBuilder = js.native
  def setUpdateDraftCcRecipientsAction(updateDraftCcRecipientsAction: UpdateDraftCcRecipientsAction): UpdateDraftActionResponseBuilder = js.native
  def setUpdateDraftSubjectAction(updateDraftSubjectAction: UpdateDraftSubjectAction): UpdateDraftActionResponseBuilder = js.native
  def setUpdateDraftToRecipientsAction(updateDraftToRecipientsAction: UpdateDraftToRecipientsAction): UpdateDraftActionResponseBuilder = js.native
}
...
@js.native
trait UpdateDraftBccRecipientsAction extends js.Object {
  def addUpdateBccRecipients(bccRecipientEmails: js.Array[String]): UpdateDraftBccRecipientsAction = js.native
}

@js.native
trait UpdateDraftCcRecipientsAction extends js.Object {
  def addUpdateCcRecipients(ccRecipientEmails: js.Array[String]): UpdateDraftCcRecipientsAction = js.native
}

@js.native
trait UpdateDraftSubjectAction extends js.Object {
  def addUpdateSubject(subject: String): UpdateDraftSubjectAction = js.native
}

@js.native
trait UpdateDraftToRecipientsAction extends js.Object {
  def addUpdateToRecipients(toRecipientEmails: js.Array[String]): UpdateDraftToRecipientsAction = js.native
}
...
@js.native
trait DecoratedText extends js.Object {
  def setAuthorizationAction(action: AuthorizationAction): DecoratedText = js.native
  def setBottomLabel(text: String): DecoratedText = js.native
  def setButton(button: Button): DecoratedText = js.native
  def setComposeAction(action: Action, composedEmailType: ComposedEmailType): DecoratedText = js.native
  def setIcon(icon: Icon): DecoratedText = js.native
  def setIconAltText(altText: String): DecoratedText = js.native
  def setIconUrl(url: String): DecoratedText = js.native
  def setOnClickAction(action: Action): DecoratedText = js.native
  def setOnClickOpenLinkAction(action: Action): DecoratedText = js.native
  def setOpenLink(openLink: OpenLink): DecoratedText = js.native
  def setSwitchControl(switchToSet: Switch): DecoratedText = js.native
  def setText(text: String): DecoratedText = js.native
  def setTopLabel(text: String): DecoratedText = js.native
  def setWrapText(wrapText: Boolean): DecoratedText = js.native
}
