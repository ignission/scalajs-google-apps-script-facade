...
trait UpdateDraftActionResponseBuilder extends js.Object {
  ...
  def setUpdateDraftBccRecipientsAction(
...
trait UpdateDraftBccRecipientsAction extends js.Object {
  def addUpdateBccRecipients(
      bccRecipientEmails: js.Array[String]
  ): UpdateDraftBccRecipientsAction = js.native
}
