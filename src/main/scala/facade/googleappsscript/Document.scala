...
trait Body extends Element {
  ...
  def setHeadingAttributes(paragraphHeading: ParagraphHeading, attributes: js.Any): Body =
    js.native
...
trait RangeBuilder extends js.Object {
  ...
  def addElementsBetween(startElement: Element, endElementInclusive: Element): RangeBuilder =
    js.native
...
trait Text extends Element {
  ...
  def replaceText(searchPattern: String, replacement: String): Element    = js.native
  def setAttributes(startOffset: Integer, endOffsetInclusive: Integer, attributes: js.Any): Text =
    js.native
  override def setAttributes(attributes: js.Any): Text = js.native
  def setBackgroundColor(startOffset: Integer, endOffsetInclusive: Integer, color: String): Text =
    js.native
  ...
  def setFontSize(startOffset: Integer, endOffsetInclusive: Integer, size: Integer): Text =
    js.native
  def setForegroundColor(startOffset: Integer, endOffsetInclusive: Integer, color: String): Text =
    js.native
  def setForegroundColor(color: String): Text = js.native
  def setItalic(italic: Boolean): Text        = js.native
  def setItalic(startOffset: Integer, endOffsetInclusive: Integer, italic: Boolean): Text =
    js.native
